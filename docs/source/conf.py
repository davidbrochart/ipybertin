...
# -*- coding: utf-8 -*-
#
# ipybertin documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipybertin', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipybertindoc'
...
latex_documents = [
    (master_doc, 'ipybertin.tex', 'ipybertin Documentation',
